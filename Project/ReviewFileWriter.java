...
public class ReviewFileWriter {
	...
	public static void main(String x[])
	{
		...
		ReviewFileWriter reviewWordCounter = new ReviewFileWriter();
		Statement st;
		int counter = 0;
		String[] words = null;
		...
		try {
			...
			String sql = ("SELECT * FROM short_review_7 where date>='2015-10-01' and date<'2016-01-01';");
			...
			{ 
				...
				text = rs.getString("text");
				 ...
				 try {
						writer = new PrintWriter("E:\\Spring 2016\\CSCI 680-K\\Project\\Review_Quarter_Text\\q4\\"+Integer.toString(counter)+"_"+review_id+".txt", "UTF-8");
						writer.println(text);
						writer.close();
